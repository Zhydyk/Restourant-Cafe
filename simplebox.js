var simplebox = (function() {
    var _1, _2, _3, _4, _5, _6, _7, _8, _9 = null,
        ...
        _17 = /[^\.]\.(swf)\s*$/i,
        _18, _19 = [],
        _1a = { padding: 10, margin: 20, width: 560, height: 340, cyclic: false, overlayShow: true, hideOnOverlayClick: true, hideOnContentClick: false, swf: { wmode: "opaque" }, h5video: { controls: "controls", preload: "metadata", autoplay: false }, flashPlayer: "http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf", titlePosition: "inside", titleShow: true, titleFormat: null, transitionIn: "fade", transitionOut: "fade", speedIn: 500, speedOut: 500, changeSpeed: 500, changeFade: 500, scrolling: "auto", autoScale: true, autoDimension: true, enableCenter: true, enableMouseWheel: true, showCloseButton: true, showNavArrows: true, enableEscapeButton: true, overlayColor: "#666", overlayOpacity: "0.3", preloadIndent: 1 };
        ...
        if (_e.type) {
            ...
            if (typeof _e.content !== "undefined") {
                ...
                if ((t = _e.video) && (arr = t.split(";")) && arr.length > 0) {
                    var _28 = { mp4: "video/mp4; codecs=\"avc1.42E01E, mp4a.40.2\"", webm: "video/webm; codecs=\"vp8, vorbis\"", ogv: "video/ogg; codecs=\"theora, vorbis\"", ogg: "video/ogg; codecs=\"theora, vorbis\"" },
                        swf = [],
                        _29, _2a = null;
                    _26 = "h5video";
